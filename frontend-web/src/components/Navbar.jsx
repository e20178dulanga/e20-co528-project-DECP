  ...
  return (
    <nav style={{
      ...
      <NavLink to="/feed" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px', marginRight: '16px' }}>
        ...
        <span style={{ fontWeight: 800, fontSize: 16, background: 'linear-gradient(135deg,var(--accent-light),var(--accent-2))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>DECP</span>
      </NavLink>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <span style={{ fontSize: 11, color: 'var(--accent-light)', textTransform: 'capitalize' }}>{user.role}</span>
          </div>
        </div>
